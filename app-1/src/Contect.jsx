...
function Contact() {
    return (
        <div className='group w-full min-h-screen py-10 bg-linear-to-br from-gray-950 via-stone-800 to-gray-950 flex justify-center items-center text-white animate-[open_2s_ease-out]'>
            <div className='flex flex-row w-[95vw] xl:w-[80vw] flex-wrap justify-center items-center gap-6'>

                {/* Left Side: Form */}
                <div className='w-full md:w-[80%] xl:w-[45%] rounded-2xl bg-white/5 border border-white/10 p-6 md:p-10 shadow-2xl backdrop-blur-sm  text-white opacity-50 group-hover:opacity-100'>
                    <form className='flex flex-col gap-6 w-full' action="">
                        <div className='text-center mb-4'>
                            <h1 className='text-3xl font-extrabold text-white'>Send a Message</h1>
                            <p className='text-stone-400 text-sm mt-2'>I'd love to hear from you!</p>
                        </div>
                        ...
                        <button className='w-full py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-lg transition-all duration-300 shadow-lg active:scale-[0.98]'>
                            Send Message
                        </button>
                    </form>
                </div>
                ...
                {/* Right Side: Info */}
                <div className='w-full md:w-[80%] xl:w-[35%] rounded-2xl p-8 flex flex-col justify-between gap-10  text-white'>
                    <div>
                        <h2 className='text-3xl font-bold mb-8 text-blue-500'>Let's Connect</h2>
                        
                        <div className='space-y-8'>
                            {/* Email */}
                            <div className='flex items-center gap-4 group'>
                                <div className='p-3 hover:bg-blue-600/20 rounded-lg group-hover:bg-blue-600 transition-colors'>
                                ...
                                <div>
                                    ...
                                    <p className='text-stone-400'>sanjaidhesihan@gmail.com</p>
                            ...
                            {/* Location */}
                            <div className='flex items-center gap-4 group'>
                                <div className='p-3  hover:bg-blue-600/50 rounded-lg group-hover:bg-blue-600 transition-colors  '>
                    ...
                    <div className='pt-6 border-t border-white/10'>
                        ...
                        <div className='flex gap-4'>
                            <a href="#" className='p-3 bg-stone-800 rounded-full hover:bg-blue-600 hover:-translate-y-1 transition-all shadow-lg'>
