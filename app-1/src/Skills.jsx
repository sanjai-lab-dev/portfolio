                ...
                <div className='w-[90vw] h-[90vh] xl:w-[60vw] xl:h[90vh] border-2 border-stone-700 backdrop-blur-sm flex flex-col items-center justify-center xl:py-20 rounded-2xl'>
                    ...
                    <div className='flex flex-row flex-wrap w-full justify-center'>
                        {images.map((img, index) => (
                            <div className=" hover:bg-gray-300/10 rounded-xl xl:p-4  animate-[start_5s_ease-out_infinite]" key={index} >
                                <img className='w-15 h-15 p-3 m-4 md:w-20 md:h-20 lg:w-25 lg:h-25 xl:w-25 xl:h-25 drop-shadow-xl drop-shadow-white/30' src={img.image} alt="loading..." />
